...
import br.com.uol.pagseguro.domain.direct.PaymentRequestWithBoleto;
...
/**
 * Class with a main method to illustrate the usage of the domain class PaymentRequestWithBoleto
 */
public class CreateDefaultPaymentWithBoleto {

    public static void main(String[] args) {
        final PaymentRequestWithBoleto request = new PaymentRequestWithBoleto();
