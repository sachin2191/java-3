...
public class PaymentRequestReceiverFees {
	 ...
	 * @param efrete
	 */
	public PaymentRequestReceiverFees(BigDecimal installmentFeeAmount,
			BigDecimal operationalFeeAmount,
			BigDecimal intermediationRateAmount,
			BigDecimal intermediationFeeAmount, BigDecimal commissionFeeAmount,
			BigDecimal efrete) {
		super();
